...
#
# CollisionWarningSelfTest
#

class CollisionWarningSelfTest(ScriptedLoadableModule):
  def __init__(self, parent):
    ScriptedLoadableModule.__init__(self, parent)
    self.parent.title = "CollisionWarningSelfTest" # TODO make this more human readable by adding spaces
...
#
# CollisionWarningSelfTestWidget
#


class CollisionWarningSelfTestWidget(ScriptedLoadableModuleWidget):
  ...
  def onApplyButton(self):
    logic = CollisionWarningSelfTestLogic()
    print("Run the algorithm")
    logic.run()

  def onReload(self,moduleName="CollisionWarningSelfTest"):
    """Generic reload method for any scripted module.
    ModuleWizard will subsitute correct default moduleName.
    """
    globals()[moduleName] = slicer.util.reloadScriptedModule(moduleName)

  def setSpeed(self,moduleName="CollisionWarningSelfTest"):
    globals()[moduleName] = slicer.util.reloadScriptedModule(moduleName)

  def onReloadAndTest(self,moduleName="CollisionWarningSelfTest"):
    try:
      self.onReload()
...
#
# CollisionWarningSelfTestLogic
#

class CollisionWarningSelfTestLogic(ScriptedLoadableModuleLogic):
...
class CollisionWarningSelfTestTest(ScriptedLoadableModuleTest):
  """
  ...
  def runTest(self):
    ...
    """
    self.setUp()
    self.test_CollisionWarningSelfTest1()

  def test_CollisionWarningSelfTest1(self):
    ...
    mainWindow.moduleSelector().selectModule('CollisionWarning')
